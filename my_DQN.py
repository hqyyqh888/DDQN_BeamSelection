# -*- coding: utf-8 -*-
"""
Created on Tue Feb 23 23:13:03 2021
     ...
     def run_n_episodes(self, num_episodes=None, save_and_print_results=True):
            ...
            while self.episode_number < num_episodes:
                ...
                if self.episode_number % 50 == 0:  
                    ...
                    print(np.array(self.benchmark_rate_list).mean())
                    ...
                    self.store_value.append(np.array(self.action_value_temp/50))
                    self.action_value_temp = torch.zeros(config.action_size)
                    
                    
                if self.episode_number == 1000:
                    self.turn_off_exploration = True
                    
                    
                if self.episode_number == 10000:
                    path01 = 'C:/Users/Administrator/Desktop/code_DDQN_DQN/result/DQN/loss'
                    scio.savemat(path01,{'loss':self.store_loss})
                    
                    path02 = 'C:/Users/Administrator/Desktop/code_DDQN_DQN/result/DQN/rate'
                    scio.savemat(path02,{'rate':self.store_rate})
                    
                    path03 = 'C:/Users/Administrator/Desktop/code_DDQN_DQN/result/DQN/value'
                    scio.savemat(path03,{'value':self.store_value})                    
                    
                    
            return
        
     def save_and_print_result(self):
            torch.save(self.q_network_local.state_dict(), 'net_params_256_40dB_DQN.pkl')
            print(np.array(self.rate_list).mean())
